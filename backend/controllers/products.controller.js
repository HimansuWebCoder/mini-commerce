...
async function getProducts(req, res) {
	...
	//  const newProducts = await Products.find();
      const newProducts = await Products.find().populate("category", "name").populate("subcategory", "name");
    //  .populate({
    //     path: 'subcategory',
...
async function getOneProduct(req, res) {
    ...
    // const getProduct = await Products.findById(id);
       const getProduct = await Products.findById(id).populate("category").populate("subcategory");
